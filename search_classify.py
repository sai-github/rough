...
cars = []
for filename in glob.iglob(r'data\vehicles\**\*.png'):
    cars.append(filename)
    
notcars = []
for filename in glob.iglob(r'data\non-vehicles\**\*.png'):
...
print(round(time.time()-t, 2), 'Seconds to extract features...',color_space,hog_channel)
